# Introduction Spring Accelerator 3.1

Spring Accelerator provides you an out-of-the-box application setup to implement your business logic. It is based on the
